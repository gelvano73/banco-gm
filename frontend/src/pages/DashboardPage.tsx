    ...
    <div className="app-shell">
      ...
      <main className="dashboard-page">
        <section className="panel balance-summary">
          <p className="balance-greeting">Olá, {client.fullName.split(' ')[0]}</p>
          <div className="balance-summary-row">
            <div>
              <span className="balance-label">Saldo total</span>
              <strong className="balance-total">{formatMoney(totalBalance)}</strong>
            </div>
            <span className="balance-accounts-count">
        ...
        <section className="panel accounts-panel" id="contas">
